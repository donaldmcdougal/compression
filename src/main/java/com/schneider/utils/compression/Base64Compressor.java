...
public class Base64Compressor {
	...
	public String decodeToString(byte[] input) {
		return new String(this.decode(input), StandardCharsets.ISO_8859_1);
	}
	...
	public byte[] encode(String input) {
		return this.encode(input.getBytes(StandardCharsets.ISO_8859_1));
	}
	...
	public String encodeToString(String input) {
		return this.encodeToString(input.getBytes(StandardCharsets.ISO_8859_1));
	}
}
