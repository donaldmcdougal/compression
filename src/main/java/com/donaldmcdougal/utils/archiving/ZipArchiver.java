 ...
 * 
 */
package com.donaldmcdougal.utils.archiving;
...
public class ZipArchiver implements Archiver {
	...
	/* (non-Javadoc)
	 * @see com.donaldmcdougal.utils.archiving.Archiver#archiveDirectory(java.nio.file.Path, java.nio.file.Path)
	 */
	@Override
	public void archiveDirectory(Path directory, Path archived)
			throws IOException, ArchiveException {

		FileOutputStream fout = new FileOutputStream(archived.toFile());
		BufferedOutputStream bout = new BufferedOutputStream(fout);
		ArchiveOutputStream stream = new ZipArchiveOutputStream(bout);
	...
	/*
	 * (non-Javadoc)
	 * @see com.donaldmcdougal.utils.archiving.Archiver#extractArchive(java.nio.file.Path, java.nio.file.Path)
	 */
	@Override
